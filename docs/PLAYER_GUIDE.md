# BARVA v3.1.0 — Complete Player Guide
...
- **Level 0→1**: 2 milestones + 1 week minimum
...
- **Level 4→5**: All 19 milestones + 6 weeks minimum
...
- **M1: Open For Business** - Survive 5 services → Unlocks Karaoke
...
- **M5: Calm House** - Complete 3 calm activity services; quiet schedule gaps preserve progress → Unlocks Open Mic
...
- **M13: Bridge Don't Bleed** - Use credit during a week, then clear it at payday with no misses → Supplier bulk x100
...
**Tier 5 (Prestige)**
- **M17: Golden Quarter** - Settle wages and rent after 4 profitable, reputable, controlled weeks → Landlord Tier 4
...
BARVA v3.1.0 rewards **operational excellence**, **strategic consistency**, and **system mastery**. There's no single path to success—whether you pursue safe growth, aggressive expansion, reputation-building, or niche specialization, the game supports your choices.
